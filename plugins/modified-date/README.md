...
To install this plugin, just download the zip version of this repository and unzip it under `/your/site/grav/user/plugins`. Then, rename the folder to `modified-date`. You can find these files on [GitHub](https://github.com/fulltrucker/grav-plugin-modified-date) or via [GetGrav.org](http://getgrav.org/downloads/plugins#extras).
