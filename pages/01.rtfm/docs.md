...
To make changes, my current plan is to edit the site files locally using Typora or Coda, depending on what I'm doing, then push to the repo which will automagically update the live site.
