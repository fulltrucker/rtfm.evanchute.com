...
taxonomy:
  category:
    - docs
routes:
  canonical: /ux-ui-design/portfolio-advice
---
...
There's tons and tons of advice written online and elsewhere about what goes into a good portfolio. I took some notes that you can [read here](/ux-ui-design/bda-ux-ui-design-course/course-notes-session-5#what-makes-a-good-portfolio) about such a thing, for starters. There's also [a few books](/ux-ui-design/recommended-reading#books) in the Recommended Reading section of this RTFM about creating your UX portfolio. A few things I have picked up elsewhere (by which I mostly mean the [Denver UX](http://denveruxers.com/) Slack community) which are not covered in my BDA course notes are:
...
I have been working my way through the onboarding process of the website [Toptal](https://www.toptal.com/) and have been tasked to submit a PDF version of my portfolio. I had created my [online portfolio](http://www.evanchute.design/), which uses a slideshow on half the screen and text on the other in case study format to present my work. I've created PDF (or document-based, or board-based) portfolios for my graphic design work, but generally those types of projects were singular deliverables and not really "case study" format. I didn't have a good idea on how to approach case studies in a PDF, so I asked the Denver UX Slack space for some examples or ideas of how to tackle this. Several folks were kind enough to share their portfolios and thoughts with me. The questions I was seeking to get answers and guidance for were:

1. How are other folks organizing projects? Can an entire project be captured on one page, or multiple?
2. Full case studies, or summations of projects?
3. Lots of images/artifacts from each project, or just final deliverables?
4. What other questions am I not thinking of?
