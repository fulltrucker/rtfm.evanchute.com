...
taxonomy:
  category:
    - docs
routes:
  canonical: /ux-ui-design/bda-ux-ui-design-course/course-notes-session-2
---
## Wireframes
...
![](https://images.zapier.com/storage/photos/d6a5fe5ff9829202598a17c0cd639fac.png)

|                                                              |                                                              |                                                              |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Table/list<br/>Nav/menu<br/>Sidebar<br/>Logo<br/>Icons<br/>Buttons<br/>Description | Profile Access<br/>Login/logout<br/>Timer<br/>Header<br/>Start/Stop Button<br/>Trash<br/>HR | Input field<br/>Project Tags/Flair<br/>Time<br/>Mini-menu<br/>View options<br/>...and more! |
